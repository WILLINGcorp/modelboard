...
const features = [
  ...
  {
    icon: <Map className="w-8 h-8 text-[#00ff66]" />,
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-bold mb-6 text-white">
            ...
            <span className="text-[#00ff66]">Our Members Have More Fun</span>
          </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16">
            <motion.div 
              ...
              className="p-6 rounded-2xl bg-black/50 border border-[#00ff66]/20 backdrop-blur-lg hover:border-[#00ff66]/40 transition-all duration-300"
            >
              <h3 className="text-4xl font-bold text-[#00ff66] mb-2">10K+</h3>
            ...
            <motion.div 
              ...
              className="p-6 rounded-2xl bg-black/50 border border-[#00ff66]/20 backdrop-blur-lg hover:border-[#00ff66]/40 transition-all duration-300"
            >
              <h3 className="text-4xl font-bold text-[#00ff66] mb-2">50K+</h3>
            ...
            <motion.div 
              ...
              className="p-6 rounded-2xl bg-black/50 border border-[#00ff66]/20 backdrop-blur-lg hover:border-[#00ff66]/40 transition-all duration-300"
            >
              <h3 className="text-4xl font-bold text-[#00ff66] mb-2">100+</h3>
            ...
            <motion.div 
              ...
              className="p-6 rounded-2xl bg-black/50 border border-[#00ff66]/20 backdrop-blur-lg hover:border-[#00ff66]/40 transition-all duration-300"
            >
              <h3 className="text-4xl font-bold text-[#00ff66] mb-2">4.9/5</h3>
        ...
        >
          {features.map((feature, index) => (
            <motion.div
              key={index}
              variants={item}
              className="p-8 rounded-2xl bg-black/50 border border-[#00ff66]/20 backdrop-blur-lg hover:border-[#00ff66]/40 transition-all duration-300 hover:-translate-y-1"
            >
              <div className="mb-6 p-4 rounded-xl bg-[#00ff66]/10 inline-block">
                {feature.icon}
              </div>
